    ...
    def read(self, locs, n_bytes):
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
                self._open_files[f_name] = open("E:\\index\\title_index\\" + f_name, 'rb')
...
DL = {}  # We're going to update and calculate this after each document. This will be usefull for the calculation of
# AVGDL (utilized in BM25)
...
class InvertedIndex:
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name):
        ...
        blob_posting_locs = bucket.blob(f"title/{bucket_id}_posting_locs.pickle")
